...
class User(AbstractUser):
    ...
    second_name = models.CharField(verbose_name='Отчество', null=True, max_length=40, blank=True, default=None)
    company = models.CharField(verbose_name='Компания', null=True, max_length=40, blank=True)
    position = models.CharField(verbose_name='Должность', null=True, max_length=40, blank=True)
    def __str__(self):
...
class ProductInfo(models.Model):
    product_id = models.PositiveIntegerField(primary_key=True, verbose_name='ID')
