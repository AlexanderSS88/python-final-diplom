...
from service.models import User, UsersContactAdress, UsersContactPhone, Product, ProductParameter, ProductInfo, Shop, \
    OrderItem, Order
...
class OrderSerializer(ModelSerializer):
    ...
    class Meta:
        model = Order
        fields = ('id', 'user', 'dt', 'status', 'ordered_items', 'total_price', 'cost_delivery', 'order_price', 'final_price', 'adress_cont', 'phone_cont')
        read_only_fields = ('id',)